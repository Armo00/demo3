        ...
        <div class="login_box">
            ...
            <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
                ...
                <el-form-item prop="password">
                    <el-input placeholder="请输入密码" v-model="loginForm.password" prefix-icon="el-icon-lock" type="password" show-password></el-input>
                </el-form-item>
                <!--button-->
...
<script>
    export default {
        data() {
            return {
                webAddress: 'http://127.0.0.1:5000',
                // 这是登录表单的数据绑定对象
                loginForm: {
                    username: 'admin',
                    password: '123456'
            ...
            login() {
                this.$refs.loginFormRef.validate(valid => {
                    ...
                    const result = this.$http.post(this.webAddress +'/login', this.loginForm).then(res => {
                        ...
                        window.sessionStorage.setItem("token", res.data.token); // token保存到客户端的sessionStorage中
